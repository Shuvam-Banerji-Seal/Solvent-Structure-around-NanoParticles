#!/usr/bin/env python3
"""
Latent Space Analysis for VAE Model
===================================
...
def analyze_latent_space(model_path: str, output_dir: str):
    ...
    model = ImprovedMDGenerativeModel(latent_dim=512, use_vae=True).to(device)
    ...
    plt.title('Latent Space PCA Path (VAE Model)')
...
if __name__ == "__main__":
    analyze_latent_space(
        model_path="../checkpoints_vae/best_model_vae.pt",
        output_dir="../logs_vae/latent_analysis"
    )
